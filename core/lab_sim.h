#ifndef BIGO_LAB_SIM_H
#define BIGO_LAB_SIM_H

/* lab_sim.h -- founder real-time: "build out all of the cloning facility simulation tech we want
 * to simulate real lab equipment as much as possible." Real answer to that: a headless equipment
