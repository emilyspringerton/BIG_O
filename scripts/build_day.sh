...
cd "$(dirname "$0")/../day"
mkdir -p ../build
gcc -std=gnu11 -O2 -Wall -Wno-unused-function -Wno-comment -Ipackages/common -Ipackages/simulation -I../core \
  apps/server/src/main.c packages/simulation/*_mod.c packages/simulation/parena_runtime.c \
  ../core/npc_archetype.c ../core/zombie_values.c ../core/humanness.c \
